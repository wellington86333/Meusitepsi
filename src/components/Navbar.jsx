...
const Navbar = () => {
    ...
    return (
        <nav
            className={`fixed w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/85 backdrop-blur-lg border-b border-primary/10 py-4 shadow-sm' : 'bg-white/70 backdrop-blur-md py-5 border-b border-primary/5'
                }`}
        >
