            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-6 text-textSecondary">
                    ...
                    <div className="p-6 bg-bg border border-primary/10 rounded-2xl shadow-sm">
                        ...
                        <ul className="list-disc pl-5 space-y-2">
                            <li>Prática clínica orientada por atualização e supervisão técnica contínua.</li>
                            <li>Associação profissional: informação pode ser confirmada no primeiro contato.</li>
                            <li>Número de conselho profissional (CRP): <strong>0215189</strong>.</li>
                        </ul>
                    </div>
                </div>
                <p className="mt-6 p-4 bg-secondary/10 border-l-4 border-secondary text-primary rounded-r-2xl">
