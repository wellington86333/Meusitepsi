...
const Contact = () => {
    ...
    return (
        <section id="contact" className="py-24 bg-gradient-to-b from-bg to-surface relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16">
                    ...
                    >
                        ...
                        <p className="text-lg font-display font-bold text-primary bg-secondary/20 p-4 rounded-xl border border-secondary/40 mb-12 max-w-md">
                            {t.contact.negotiableValues}
                        </p>

                        <div className="space-y-8">
                            <div className="flex items-start gap-4">
                                <div className="w-12 h-12 bg-surface rounded-xl border border-primary/10 flex items-center justify-center text-secondary">
                                    <Phone size={24} />
                                </div>
                                <div>
                            ...
                            <div className="pt-8 border-t border-primary/10">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <div className="flex items-center gap-2 bg-surface px-4 py-2 border border-primary/10 rounded-full">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="bg-surface p-8 md:p-12 rounded-2xl border border-primary/10 shadow-xl"
                    >
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-bg rounded-xl border border-primary/15 p-4 text-primary placeholder-primary/30 focus:border-secondary focus:outline-none transition-colors"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full bg-bg rounded-xl border border-primary/15 p-4 text-primary placeholder-primary/30 focus:border-secondary focus:outline-none transition-colors resize-none"
                                ></textarea>
                            </div>

                            <button
                                type="submit"
                                className="w-full bg-primary text-bg font-bold uppercase tracking-widest py-4 rounded-xl hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-lg"
                            >
